...
def BN(components, n_iter):
    ...
    for j in range(n_iter):
        ...
        for i in r:
            ...
            if (i == "FOXO3A"):
                #x[i] = x["Virus"]
                x[i] = (x["ROS"] or x["STAT3"]) and not x["IKKB a/b"]
...
def main():
    random.seed(0)
    components = ["Virus","Viral_Repl","ACE2","PKC","ANG_2_T1R","ANG_2","ADAM_17","SIL6R","TLR4","RIG1","NFKB","IKKB a/b", "TNF","IRF3","STAT1","STAT3", "IL6", "IL6R","ISG","C_FLIP","INF a/b","NRLP3","CASP1","FOXO3A","IFNR","BCL_2","TBid","Bax_Bak","CASP9","ROS","TNFR","FADD","Pyroptosis","IL1","IL1R","MLKL","Necroptosis","RIPK1&3","CASP8","Apoptosis"]
    #components.sort()
